        ...
        <ul class="list-inline dev-icons skills-cont">
            <div class="core">
                ...
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/svelte.svg" alt="svelte logo" />
                </li>
            ...
            <div class="tools">
                ...
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/firebase.svg" alt="firebase logo" />
                </li>
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/git.svg" alt="git logo" />
                </li>
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/pwa.svg" alt="pwa logo" />
                </li>
            ...
            <div class="design">
                ...
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/figma.svg" alt="figma logo" />
                </li>
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/xd.svg" alt="xd logo" />
                </li>
                <li class="list-inline-item">
                    <img class="skill-logo" src="img/uxui.svg" alt="ui-ux logo" />
                </li>
            </div>
        </ul>
